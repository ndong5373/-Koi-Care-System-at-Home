...
VALUES 
('user1', 'password123', 'Nguyễn Văn A', '123 Street', '0123456789', 'nguyenvana@example.com'),
('user2', 'password456', 'Trần Văn B', '456 Avenue', '0987654321', 'tranvanb@example.com');

INSERT INTO MaintenancePerson (ho_ten, so_dien_thoai, email, kinh_nghiem_nam)
VALUES 
('Nguyễn Văn C', '0987654321', 'nguyenvanc@gmail.com', 5),
('Trần Văn D', '0123456789', 'tranvand@gmail.com', 3);
...
('Bánh thưởng', 'Loại B', 'Trung bình', '2026-06-30');
